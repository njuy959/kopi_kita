    ...
    <form method="POST"
        ...
        <div class="space-y-6 p-5 sm:p-7">
            ...
            <div class="flex items-center gap-4 rounded-2xl bg-[#F5E6CA]/40 p-4">
                ...
                <div class="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-full bg-[#5C3D2E] text-xl font-bold text-white">
                    {{ strtoupper(substr($user->name, 0, 1)) }}
                </div>

                <div class="min-w-0">
                    <p class="font-bold text-[#1F1F1F]">
                        {{ $user->name }}
                    </p>
            ...
            <div>
                ...
                <input type="text"
                       ...
                       required
                       class="w-full rounded-xl border border-gray-300 px-4 py-3 text-sm text-gray-900 outline-none transition focus:border-[#5C3D2E] focus:ring-2 focus:ring-[#5C3D2E]/10">
            ...
            <div>
                ...
                <select id="role"
                        ...
                        class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900 outline-none transition focus:border-[#5C3D2E] focus:ring-2 focus:ring-[#5C3D2E]/10 disabled:cursor-not-allowed disabled:bg-gray-100">
                ...
                @else
                    <p class="mt-2 text-xs text-gray-500">
                        Tentukan hak akses user berdasarkan kebutuhannya.
                    </p>
                @endif
        ...
        {{-- Footer --}}
        <div class="flex flex-col-reverse gap-3 border-t border-gray-100 bg-gray-50 px-5 py-4 sm:flex-row sm:justify-between sm:px-7">
